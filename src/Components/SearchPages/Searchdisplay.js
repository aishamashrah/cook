    ...
    <label class="relative block col-span-8 mx-2 sm:mx-0 sm:col-span-4 sm:grid-cols-12">
        ...
        <input class="placeholder:italicawq23a block bg-white md:w-96 sm:w-96 mx-10 rounded-md py-2 sm:pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search
            ...
            <nav aria-label="Page navigation example ">
                <ul class="inline-flex -space-x-px p-5 my-10 sm:mx-40 first-letter ">
                    <li>
                    ...
                    <li>
                        <a href="#" class="sm:px-5 py-2 leading-tight text-gray-500 bg-white border  hover:bg-gray-100 text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">1</a>
                    </li>
                    <li>
                        <a href="#" class="sm:px-5 py-2 leading-tight text-gray-500 bg-white border  hover:bg-gray-100 text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">2</a>
                    </li>
                    <li>
                        <a href="#" class="sm:px-5 py-2 leading-tight text-gray-500 bg-white border  hover:bg-gray-100 text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">3</a>
                    </li>
